    ...
    public void configure(HttpSecurity http) throws Exception {
        http.addFilterAfter(jsonFilter, BasicAuthenticationFilter.class)
                ...
                .antMatchers("/v2/api-docs", "/configuration/ui", "/swagger-resources/**", "/configuration/**", "/swagger-ui.html", "/index", "/pub/**", "/api/token", "/api/auth/pwd/verify-token",
                        "/api/auth/activate/resend", "/api/auth/pwd", "/api/auth/logout", "/actuator/**", "/auth/internal-login").permitAll()
                .antMatchers("/v1/account/request-forget-password", "/v1/account/forget-password","/v1/account/verify-credential").permitAll()
                .antMatchers("/v1/account/request-forget-password", "/v1/account/forget-password","/v1/account/verify-credential", "/v1/account/register-seller").permitAll()
